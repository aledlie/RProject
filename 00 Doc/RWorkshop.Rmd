...
###Dependencies
####Shiny Configuration
Install shinyApps and set credentials for shinyapps.io:
```{r}
devtools::install_github('rstudio/shinyapps')
shinyapps::setAccountInfo(name='izac', token='17D9871441F9D62A171F637C90D55BA4', secret='nQyjOYbrmoR0L9cs1NR5a4FlFAzoPIVouilfTLYp')
```
